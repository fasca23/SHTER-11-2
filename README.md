...
4. Неправильный идентификатор платформы исправил (в 2ух местах) -  platform_id = "standard-v3"
...
1. Создал новые переменные в variables.tf
2. Подставил их в main.tf
3. Изменений в terraform plan нет
